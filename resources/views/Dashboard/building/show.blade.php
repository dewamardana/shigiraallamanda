  ...
  <div class="bg-white p-8 rounded-xl shadow-2xl m-5 mx-auto max-w-4xl w-full">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm text-slate-700">
      <div class="md:col-span-2 bg-slate-100 p-4 rounded-lg">
        <p class="text-xs font-semibold text-slate-500 mb-1">{{ __('dashboardBuilding.form.description') }}</p>
    ...
    <div class="flex justify-between mt-8">
      <a href="/dashboard/building"
        class="bg-blue-500 text-white text-sm font-semibold px-4 py-2 rounded hover:bg-blue-600 flex items-center gap-1">
        <i data-feather="arrow-left"></i>{{ __('button.back') }}
      </a>
    </div>
  </div>
@endsection
