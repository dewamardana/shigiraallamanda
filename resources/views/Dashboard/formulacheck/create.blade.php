...
@section('content')
  <div class="bg-white p-5 rounded-xl shadow-2xl m-5 mx-auto max-w-5xl w-full">
    <h2 class="font-bold text-4xl text-center text-black-500 mb-8">{{ __('dashboardFormulaCheck.create.title') }}</h2>
      ...
      <div class="flex flex-col gap-5">
        ...
        <div>
          <label for="active" class="inline-flex items-center cursor-pointer">
            <span class="mr-3 text-sm font-medium text-teal-1001">{{ __('dashboardFormulaCheck.form.active') }}</span>
            <div class="relative">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
          <div>
            ...
            <input type="number" name="jumlah_kamar" id="jumlah_kamar" value="{{ old('jumlah_kamar') }}" min="0"
          ...
          <div>
            ...
            <input type="number" name="mengajar" id="mengajar" value="{{ old('mengajar') }}" min="0"
              aria-describedby="helper-text-explanation"
              class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
              placeholder="0" required />
            @error('mengajar')
          ...
          <div>
            ...
            <input type="number" name="pembersihan_khusus" id="pembersihan_khusus"
              value="{{ old('pembersihan_khusus') }}" min="0" aria-describedby="helper-text-explanation"
              class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
              placeholder="0" required />
          ...
          <div>
            ...
            <input type="number" name="mengangkat_barang" id="mengangkat_barang" value="{{ old('mengangkat_barang') }}"
          ...
          <div>
            ...
            <input type="number" name="membersihkan_gudang" id="membersihkan_gudang"
              value="{{ old('membersihkan_gudang') }}" min="0" aria-describedby="helper-text-explanation"
              class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
              placeholder="0" required />
          ...
          <div>
            ...
            <input type="number" name="obat_pool" id="obat_pool" value="{{ old('obat_pool') }}" min="0"
              aria-describedby="helper-text-explanation"
              class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
              placeholder="0" required />
            @error('obat_pool')
          ...
          <div>
            ...
            <input type="number" name="membersihkan_pool" id="membersihkan_pool"
              value="{{ old('membersihkan_pool') }}" min="0" aria-describedby="helper-text-explanation"
              class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
              placeholder="0" required />
