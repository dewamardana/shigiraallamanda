    ...
    <div class="mb-6">
      <form method="GET" action="{{ route('userpoint') }}" class="grid sm:flex sm:flex-wrap sm:items-end gap-4">
        ...
        <div class="relative w-full sm:w-auto">
          ...
          <input id="filter_date" name="filter_date" datepicker datepicker-autohide datepicker-autoselect-today
            datepicker-format="yyyy/mm" type="text" value="{{ old('filter_date', $filter_date ?? '') }}"
