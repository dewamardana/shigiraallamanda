...
<div class="bg-white p-5 rounded-xl shadow-2xl m-5 mx-auto max-w-5xl w-full">
    <h2 class="font-bold text-4xl text-center text-black-500 mb-8">{{ __('dashboardUserEdit.title') }}</h2>
        ...
        <div class="flex flex-col md:flex-row gap-8 justify-center p-6">
            ...
            <div class="w-full space-y-5">
                ...
                <div>
                    ...
                    <input type="text" name="department" id="department" value="{{ old('department', $user->department) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="{{ __('dashboardUserCreate.department_placeholder') }}" required />
                    @error('department')
                        <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                {{-- Roles --}}
                <div>
                    <label class="block mb-2 text-sm font-medium text-teal-1001">Roles</label>
                ...
                <div class="flex justify-center gap-4 mt-6">
                    <button type="submit"
                        ...
                        {{ __('dashboardUserEdit.update_worker') }}
                    </button>
