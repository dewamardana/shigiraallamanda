      ...
      <form action="{{ route('officeStore') }}" method="POST">
        ...
        <div class="mb-4">
          ...
          <input type="text" value="{{ $user->nama }}"
            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg w-full p-2.5" readonly />
        </div>
        ...
        <div class="mb-6">
          ...
          <div class="relative">
            ...
            <input type="text" id="date" name="date" value="{{ now()->toDateString() }}" readonly
