          ...
          <table class="min-w-full text-sm text-gray-800 border-collapse">
            <thead>
              <tr class="bg-teal-1001 text-white uppercase text-xs tracking-wider">
                <th class="px-4 py-3 text-center border border-gray-300 whitespace-nowrap">
                  {{ __('history.monthly_summary.date') }}</th>
                <th class="px-4 py-3 text-center border border-gray-300 whitespace-nowrap">
                  {{ __('history.monthly_summary.total_points') }}</th>
              </tr>
            </thead>
            <tbody>
              @foreach ($monthlySummary as $summary)
                <tr class="hover:bg-yellow-50 {{ $loop->odd ? 'bg-slate-50' : 'bg-white' }}">
                  ...
                  <td
                    class="px-4 py-2 text-center font-bold border border-gray-300
            ...
            <tfoot>
              <tr class="bg-gray-100 font-bold">
                <td class="px-4 py-3 text-center border border-gray-300">{{ __('history.monthly_summary.total_month') }}
                </td>
